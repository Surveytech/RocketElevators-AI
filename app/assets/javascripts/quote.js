...
function hideQuestions() {
  /////// Hide the questions
  $("#number-of-floors").attr("class", "hidden");
  $("#number-of-basements").attr("class", "hidden");
  $("#number-of-companies").attr("class", "hidden");
  $("#number-of-parking-spots").attr("class", "hidden");
  $("#maximum-occupancy").attr("class", "hidden");
  $("#number-of-apartments").attr("class", "hidden");
  $("#number-of-corporations").attr("class", "hidden");
  $("#number-of-elevators").attr("class", "hidden");
...
//Show the ResidentialQuestions
  $("#number-of-apartments").attr("class", "visible");
  $("#number-of-floors").attr("class", "visible");
  $("#number-of-basements").attr("class", "visible");
}
...
function commercialQuestions() {
  ...
  $("#number-of-floors").attr("class", "visible");
  $("#number-of-basements").attr("class", "visible");
  $("#number-of-companies").attr("class", "visible");
  $("#number-of-parking-spots").attr("class", "visible");
  $("#number-of-elevators").attr("class", "visible");
}
...
//Show the Corporate Questions
  ...
  $("#number-of-basements").attr("class", "visible");
  $("#number-of-parking-spots").attr("class", "visible");
  $("#number-of-corporations").attr("class", "visible");
  $("#maximum-occupancy").attr("class", "visible");
}
